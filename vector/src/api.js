...
export async function apiFetchZdate(start_date) {
...
export async function apiFetchSalesStage() {
...
export async function apiFetchProductCategory() {
...
export async function apiFetchProbability() {
...
export async function apiFetchOpportunityTypes() {
...
export async function apiFetchWinLoseCodes() {
...
export async function apiFetchSalesTeam(name) {
...
export async function apiPostCustomers(payload) {
...
export async function apiFetchIndustrySegement() {
